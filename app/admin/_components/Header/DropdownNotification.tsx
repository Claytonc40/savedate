  ...
  return (
    <li className="relative">
      <Button
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:border-boxdark hover:text-primary dark:border-boxdark dark:bg-bodydark2 dark:text-white dark:hover:border-white"
      >
        <span
