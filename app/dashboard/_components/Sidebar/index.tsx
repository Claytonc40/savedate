...
import { AlertTriangle, Home, LogOut, Printer } from 'lucide-react';
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-8 ml-4 border-b py-2 font-semibold text-white">Menu</h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-5 dark:hover:bg-meta-5 ${
                    pathname === '/dashboard/alert' && 'bg-meta-6 text-white'
                  }`}
                >
                  <AlertTriangle />
                  Alertas
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-meta-5 dark:hover:bg-meta-5 ${
                    pathname === '/dashboard/profile' && 'bg-meta-6 text-white'
                  }`}
                >
                  <FaUserGear />
                  Perfil
